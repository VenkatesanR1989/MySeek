...
package com.example.showcaseviewexample.showcase;
...
import com.example.showcaseviewexample.R;
import com.example.showcaseviewexample.showcase.shapes.Circle;
import com.example.showcaseviewexample.showcase.shapes.RoundRect;
...
public final class Showcase {
    ...
    private static final float DEFAULT_ADDITIONAL_RADIUS_RATIO = 1.5f;
    private static final String SHARED_TUTO = "SHARED_TUTO";
    private FrameLayout container;
    private ShowView tutoView;
    ...
    private Showcase(@NonNull Activity activity) {
        ...
        this.tutoView = new ShowView(activity);
    ...
    public Showcase setVisibleView(@IdRes int viewId, int visiblity) {
        View view = container.findViewById(viewId);
        if (view != null) {
